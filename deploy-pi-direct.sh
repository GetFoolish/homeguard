...
# Direct Pi deployment with password authentication
# For Pi at 192.168.4.71 with user: raspberrypi, password: pi
...
# Transfer files using scp with password
echo "📤 Transferring files to Pi..."
echo "When prompted, enter password: rp"

# Use scp to transfer files
scp -r "$DEPLOY_DIR"/* "$PI_USER@$PI_IP:/home/raspberrypi/"

# Run installation
echo "🔧 Running installation on Pi..."
echo "When prompted, enter password: rp"

ssh "$PI_USER@$PI_IP" 'cd /home/raspberrypi && sudo bash install.sh'
